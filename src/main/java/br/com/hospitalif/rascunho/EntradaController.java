...
public class EntradaController {
	...
	private TextField txtEntrada0; // Value injected by FXMLLoader

	@FXML // fx:id="txtEntrada1"
	private TextField txtEntrada1; // Value injected by FXMLLoader

	@FXML // fx:id="txtEntrada2"
	private TextField txtEntrada2; // Value injected by FXMLLoader

	@FXML // fx:id="txtEntrada3"
	private TextField txtEntrada3; // Value injected by FXMLLoader

	@FXML // fx:id="txtEntrada4"
	private TextField txtEntrada4; // Value injected by FXMLLoader
	...
	void handleSubmitButtonAction(ActionEvent event) throws IOException {
		...
		if (txtEntrada0.getText().equals("")) {
			...
			EntradaDAO efdaoe = new EntradaDAO();
			efdaoe.inserir(en);
