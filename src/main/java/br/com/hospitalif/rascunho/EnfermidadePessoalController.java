...
public class EnfermidadePessoalController {
	...
	@FXML // fx:id="comEnfermidadePessoal2"
	private ChoiceBox<?> comEnfermidadePessoal2; // Value injected by FXMLLoader
	...
	void handleSubmitButtonAction(ActionEvent event) throws IOException {
		...
		if (txtEnfermidadePessoal0.getText().equals("")) {
			Stage stage = (Stage) btnEnfermidadePessoal.getScene().getWindow();
			...
			EnfermidadePessoal enfep = new EnfermidadePessoal();
	...
	void initialize() {
		...
		assert comEnfermidadePessoal2 != null : "fx:id=\"comEnfermidadePessoal2\" was not injected: check your FXML file 'EnfermidadePessoal.fxml'.";
